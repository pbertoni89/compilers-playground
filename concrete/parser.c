...
{
       0,    16,    16,    20,    23,    27,    29,    33,    33,    38,
      41,    45,    45,    50,    52,    54,    58,    58,    63,    66,
      69,    73,    76,    80,    82,    84
};
#endif
...
#line 33 "parser.y" /* yacc.c:1646  */
    {	(yyval) = nontermnode(NDEF_STAT);
														(yyval)->child = (yyvsp[-3]);
														(yyvsp[-3])->brother = (yyvsp[-1]);}
#line 1279 "parser.c" /* yacc.c:1646  */
    break;

  case 9:
#line 38 "parser.y" /* yacc.c:1646  */
    {	(yyval) = nontermnode(NDEF_LIST);
										(yyval)->child = (yyvsp[-2]);
										(yyvsp[-2])->brother = (yyvsp[0]);}
...
#line 1300 "parser.c" /* yacc.c:1646  */
  ...
  case 12:
#line 45 "parser.y" /* yacc.c:1646  */
    {	(yyval) = nontermnode(NDOMAIN_DECL);
												(yyval)->child = (yyvsp[-2]);
												(yyvsp[-2])->brother = (yyvsp[0]);}
...
#line 50 "parser.y" /* yacc.c:1646  */
    {	(yyval) = nontermnode(NDOMAIN);
					(yyval)->child = keynode(T_INTEGER);}
...
#line 58 "parser.y" /* yacc.c:1646  */
    {	(yyval) = nontermnode(NASSIGN_STAT);
																(yyval)->child = (yyvsp[-4]);
																(yyvsp[-4])->brother = (yyvsp[-1]);}
#line 1343 "parser.c" /* yacc.c:1646  */
    break;

  case 18:
#line 63 "parser.y" /* yacc.c:1646  */
    {	(yyval) = nontermnode(NTUPLE_LIST);
										(yyval)->child = (yyvsp[-1]);
										(yyvsp[-1])->brother = (yyvsp[0]);}
...
#line 69 "parser.y" /* yacc.c:1646  */
    {	(yyval) = nontermnode(NTUPLE_CONST);
											(yyval)->child = (yyvsp[-1]);}
...
#line 73 "parser.y" /* yacc.c:1646  */
    {	(yyval) = nontermnode(NSIMPLE_CONST_LIST);
															(yyval)->child = (yyvsp[-2]);
															(yyvsp[-2])->brother = (yyvsp[0]);}
...
#line 80 "parser.y" /* yacc.c:1646  */
    {	(yyval) = nontermnode(NSIMPLE_CONST);
							(yyval)->child = intconstnode();}
